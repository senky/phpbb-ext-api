...
class simple_test extends \phpbb_database_test_case
{
	...
	public function test_column()
	{
		...
		$this->assertTrue($db_tools->sql_column_exists(USERS_TABLE, 'user_api'), 'Asserting that column "user_api" exists');
		$this->assertFalse($db_tools->sql_column_exists(USERS_TABLE, 'user_api_void'), 'Asserting that column "user_api_void" does not exist');
	}
}
